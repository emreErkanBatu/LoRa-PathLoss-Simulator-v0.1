...
plt.legend(['Model-1_Train', 'Model-1_Val','Model-2_Train', 'Model-2_Val','Model-3_Train', 'Model-3_Val'],bbox_to_anchor=(0, 1.02, 1, 0.5), loc="lower right", borderaxespad=0, ncol=8,fontsize=10)# plt.legend(['train', 'val'], loc='upper left')
...
draw(epochs,df_history3["loss"],plt,len(df_history3["loss"])-2,'#2ca02c',115,"95",'-')
draw(epochs,df_history3["val_loss"],plt,len(df_history3["val_loss"])-2,'#2ca02c',142,"90",'--')
