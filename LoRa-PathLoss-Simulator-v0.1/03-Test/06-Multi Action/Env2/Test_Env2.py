...
def valueCreate(SigVal,numL):
    sigList=[] 
    if numL==3:
        normC=[[ -139.221, -49.869],[ -146.181, -49.869],[ -139.708, -48.486999999999995]]
    if numL==5:
        normC=[[ -169.393, -50.365],[-139.221, -49.869],[ -146.181, -49.869],[-153.171, -50.365],[-166.15, -48.183]]
    if numL==9:
...
personNum=3
beginPos=[(107, 113),(683, 357),(768, 749)]
